...
public class DuplicateLead {
	...
	public static void main(String[] args) {
		...
		////Clear and enter User details and click on Create
		driver.findElement(By.id("createLeadForm_companyName")).clear();
		driver.findElement(By.id("createLeadForm_companyName")).sendKeys("BOA_1");
		
		driver.findElement(By.id("createLeadForm_firstName")).clear();
		driver.findElement(By.id("createLeadForm_firstName")).sendKeys("Sujit_1");

		//Get Title
		createbutton(driver);
	}

public static void createbutton(ChromeDriver driver) {
